  ...
  (document.onclick = function (a) {
    var b = document.getElementById("menutoggle"),
      c = b.currentStyle
        ...
        : getComputedStyle(b, null).display;
    "block" === c &&
      a.target !== b &&
      new RegExp(" active ").test(" " + b.className + " ") &&
      changeClass(b, "navtoogle active", "navtoogle");
  }),
  $(function () {
    $("article").fitVids();
  }),
    ...
    window.addEventListener(
      ...
      function (b) {
        if ($("#table-of-contents").length) {
          var c = null,
            d = null;
          $(":header").each(function (b, e) {
            if ($(e).attr("id")) {
              var f = $(e).offset().top - $(document).scrollTop();
              a / 2 > f &&
                (null == c || Math.abs(f) < Math.abs(c)) &&
                ((c = f), (d = $(e).attr("id")));
            }
          }),
            $("#markdown-toc a").removeClass("header-active"),
            d &&
              $("#markdown-toc a[href$='#" + d + "']").addClass(
                "header-active"
              );
        }
      },
      ...
      $('#markdown-toc a[href^="#"]').on("click", function (a) {
        var b = this,
        ...
        c.length &&
          ...
          $("html, body")
            .stop()
            .animate({ scrollTop: c.offset().top }, 500)
            .promise()
            .done(function () {
