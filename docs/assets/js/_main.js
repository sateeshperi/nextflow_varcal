...
menuElements.insertAdjacentHTML(
  "afterBegin",
  '<button type="button" role="button" id="menutoggle" class="navtoogle navicon-lines-button x" aria-hidden="true"><span class="navicon-lines"></span>menu</button>'
);
...
$(document).ready(function () {
  ...
  window.addEventListener(
    ...
    function (event) {
      ...
      if (target_id) {
        $("#markdown-toc a[href$='#" + target_id + "']").addClass(
          "header-active"
        );
      }
    },
